        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {/* Badge */}
                <motion.div
                  ...
                  >
                    ...
                    <span className="hidden max-lg:inline text-gray-500 text-xs ml-1">— 3D interactive view</span>
                  </motion.div>
            ...
            <motion.div
              ...
              className="relative lg:block max-lg:mt-12"
              style={{
                perspective: 1000,
              }}
            >
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-full p-8 flex flex-col justify-center items-center text-center">
                    ...
                    <p className="text-gray-300">React, Next.js, and React Native systems for fintech and blockchain products</p>
